...
- interCoupleBalance: positive means Grishma owes Kushvanth; negative means Kushvanth owes Grishma.
...
- Split expense: expense_for both with paid_by grishma means Grishma paid the total and each owes half. Shares must equal the total; inter-couple updates when one person pays for another's share.
