...
export default function FlexPage() {
  ...
  const hydrate = useRulesStore((state) => state.hydrateFromServer);
  ...
  return (
    <CompactPageShell
      ...
      action={
        ...
        >
          <Plus className="h-3 w-3" /> Log a block
        </button>
      }
    >
      <GlassCard className="!p-3 border-t-[3px] border-t-[#0077FF]">
        ...
        <div className="mb-3 flex items-center justify-center gap-1">
          <button
            ...
            aria-label="Earlier"
            className="rounded-lg p-1.5 text-muted transition-colors hover:bg-black/5 disabled:opacity-25 dark:hover:bg-white/10"
          >
                      ...
                      {day.list.map((block) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="shrink-0 rounded-md p-1.5 text-[#ff3b30] hover:bg-black/5 dark:hover:bg-white/10"
                          >
